...
class LineChart(MatplotlibViz):
    ...
    def visualization(self, entity_id, model):
        ...
        event_count = model.event_counts(entity_id)

        # Use the pandas .fillna method to fill nulls with 0
        event_count.fillna(0, inplace=True)
        
        # User the pandas .set_index method to set
        # the date column as the index
        event_count.set_index('event_date', inplace=True)
        ...
        event_count = event_count.cumsum()
        
        
        # Set the dataframe columns to the list
        # ['Positive', 'Negative']
        event_count.columns = ['Positive', 'Negative']
...
class BarChart(MatplotlibViz):
    ...
    def visualization(self, entity_id, model):
        ...
        # Add gridlines to make visual clearer
